...
async function openCustomer(id){
 ...
 <div class="toolbar"><button class="btn" data-add-sale="${c.id}">${t('recordSale')}</button><button class="btn secondary" data-add-report="${c.id}">${t('addFollowup')}</button>${managementButtons}${fullAdminButtons}</div>
